  ...
  <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
    <div className="max-w-md w-full text-center">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Check-in Disabled</h1>
        <p className="text-gray-600">Check-in will be enabled closer to the event date.</p>
      </div>
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <a href="/registration" className="btn btn-primary">Go to Registration</a>
      </div>
    </div>
  </div>
);
